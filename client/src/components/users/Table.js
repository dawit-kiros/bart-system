  ...
  return (
    ...
    <>
      ...
      <div className="flex justify-between items-center mx-4 my-8">
        ...
        <div>
          <button  onClick={() => setShowModal(true)} className="bg-lime-500 hover:bg-lime-700 text-white font-bold py-2 px-8 rounded-md">
            Add New User
          </button>
          {showModal ? (
        <>
            ...
            <div className="relative w-auto my-6 mx-auto max-w-3xl">
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                <div className="flex items-start justify-between p-3 border-b border-solid border-gray-300 rounded-t ">
                  <h3 className=" text-sm  ">Add New user</h3>
                  <button
